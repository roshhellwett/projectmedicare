...
const doctorsData = [
  {
    ...
    qualifications: ["MBBS", "DNB-Internal Medicine", "Fellowship in Critical Care Medicine", "Diabetologist", "Cardiology PDT(III)"]
  },
  {
  ...
  },
  {
    ...
    qualifications: ["MBBS", "MD (Paediatrics)", "Fellowship (Neonatology)", "PGPN (Boston)", "Consultant Pediatrician & Neonatologist"]
  },
  {
    nameMatch: "Megha Agarwal",
    department: "Dermatology",
    specialty: "Consultant Dermatologist and Aesthetic Physician",
    qualifications: ["MBBS", "MD (Dermatology, Venereology and Leprosy)", "Consultant Dermatologist and Aesthetic Physician"]
  },
  {
    nameMatch: "Soumyojyoti Chongar",
    department: "Orthopaedic",
    specialty: "Consultant Orthopaedic Surgeon",
    qualifications: ["MBBS", "DNB (Orthopaedics)", "Consultant Orthopaedic Surgeon", "Specialist in Joint Replacement & Spine Surgery"]
  },
  {
  ...
  },
  {
    ...
    qualifications: ["MBBS", "DA Consultant Anaesthesiologist and General Physician"]
  },
  {
    nameMatch: "Shristy Shaw",
    department: "General and Aesthetic Dentist",
    specialty: "General and Aesthetic Dentist",
    qualifications: ["BDS", "FAGE (Manipal)", "CART", "Dental Laser (California)"]
  },
  {
    nameMatch: "Neeraj Agarwal",
    department: "Urology",
    specialty: "Consultant Urologist, Uro-oncologist, Uro-Gynecologist",
    qualifications: ["MBBS", "DNB (General Surgery)", "MCH (Urology)", "FMAS (AMASI)", "MNAMS", "Consultant Urologist, Uro-oncologist, Uro-Gynecologist"]
  },
  {
    nameMatch: "S. Pal",
...
async function updateDoctors() {
  ...
  const { data: existingDoctors, error: fetchError } = await supabase.from("doctors").select("id, name");
  ...
  for (const docUpdate of doctorsData) {
    ...
    const matchedDoctor = existingDoctors?.find(d => d.name.toLowerCase().includes(docUpdate.nameMatch.toLowerCase()));
    
    if (!matchedDoctor) {
      console.warn(`Could not find a match for ${docUpdate.nameMatch}. Skipping.`);
      continue;
    }
