      ...
      <div className="container">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {packages.map((pkg) => (
            <div
              key={pkg.id}
              className="card flex flex-col justify-between hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-md"
            >
              <div>
                ...
                <div className="mt-4 flex items-end gap-2">
                  ...
                  <span className="text-sm text-muted line-through mb-1">
                    ₹{pkg.market_price}
                  </span>
                </div>
