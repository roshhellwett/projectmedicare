...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFmbXRvbnJvamlibW5mcWJsZmRtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4NTkyOTAxMCwiZXhwIjoyMTAxNTA1MDEwfQ.Y0yKkXHasSCzpZVyCq8TW0Qx4BFCk5ytZaV7VGBRFrw";

const supabase = createClient(supabaseUrl, supabaseKey);

async function seed() {
  console.log("Seeding Medicines...");
  const medicines = JSON.parse(readFileSync("apps/frontend/src/data/medicines.json", "utf-8"));
  ...
  const rates = JSON.parse(readFileSync("apps/frontend/src/data/rates.json", "utf-8"));
